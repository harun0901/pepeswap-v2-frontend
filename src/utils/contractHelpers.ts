...
import pepeAbi from 'config/abi/pepe.json'
...
export const getPepeContract = (web3?: Web3) => {
  return getContract(pepeAbi, getPepeAddress(), web3)
}
...
export const getPepeVaultContract = (web3?: Web3) => {
  return getContract(pepeVaultAbi, getPepeVaultAddress(), web3)
}
