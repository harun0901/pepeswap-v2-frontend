...
import { useMasterchef, usePepe, useSousChef, useLottery, usePepeVaultContract } from './useContract'
...
export const useVaultApprove = (setLastUpdated: () => void) => {
  ...
  const handleApprove = () => {
    cakeContract.methods
      ...
      .on('receipt', () => {
        toastSuccess(t('Contract Enabled'), t('You can now stake in the %symbol% vault!', { symbol: 'PEPE' }))
        setLastUpdated()
        setRequestedApproval(false)
      })
      .on('error', (error) => {
