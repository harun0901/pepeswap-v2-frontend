...
const BountyCard = () => {
  ...
  const TooltipComponent = ({ fee }: { fee: number }) => (
    <>
      ...
      <Text mb="16px">
        {t(
          'Whenever you successfully claim the bounty, you’re also helping out by activating the Auto PEPEPEPE Pool’s compounding function for everyone.',
        )}
      </Text>
      <Text style={{ fontWeight: 'bold' }}>
        {t('Auto-Compound Bounty: %fee%% of all Auto PEPE pool users pending yield', { fee: fee / 100 })}
      </Text>
    </>
  )
        ...
        <CardBody>
          ...
          <Flex alignItems="center" justifyContent="space-between">
            <Flex flexDirection="column" mr="12px">
              <Heading>
                {hasFetchedPepeBounty ? (
                  <Balance fontSize="20px" bold value={pepeBountyToDisplay} decimals={3} />
                ) : (
