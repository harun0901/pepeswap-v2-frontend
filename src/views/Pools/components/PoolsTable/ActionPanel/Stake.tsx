...
import VaultStakeModal from '../../PepeVaultCard/VaultStakeModal'
...
const Staked: React.FunctionComponent<StackedActionProps> = ({ pool, userDataLoaded }) => {
  ...
  const stakedAutoDollarValue = getBalanceNumber(pepeAsBigNumber.multipliedBy(stakingTokenPrice), stakingToken.decimals)
  ...
  const [onPresentVaultUnstake] = useModal(<VaultStakeModal stakingMax={pepeAsBigNumber} pool={pool} isRemovingStake />)
        ...
        <ActionContent>
          <Flex flex="1" pt="16px" flexDirection="column" alignSelf="flex-start">
            <Balance
              ...
              fontSize="20px"
              decimals={5}
              value={isAutoVault ? pepeAsNumberBalance : stakedTokenBalance}
            />
            <Balance
              fontSize="12px"
              display="inline"
