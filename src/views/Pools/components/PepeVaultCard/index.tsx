...
import RecentPepeProfitRow from './RecentPepeProfitRow'

const StyledCardBody = styled(CardBody)<{ isLoading: boolean }>`
  min-height: ${({ isLoading }) => (isLoading ? '0' : '254px')};
`

interface PepeVaultProps {
  pool: Pool
  showStakedOnly: boolean
}

const PepeVaultCard: React.FC<PepeVaultProps> = ({ pool, showStakedOnly }) => {
